...
def apply_stock_reconciliation_calculation(doc, method=None):
    ...
    # Generated by Month End Production Cost Adjustment.
    # Do not run the legacy reconciliation calculation twice.
    if getattr(doc.flags, "skip_pc_production_reconciliation", False):
        return
